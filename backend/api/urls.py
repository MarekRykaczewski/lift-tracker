...
from .views import ExportWorkoutsView, GetWorkoutBreakdownView, MoveWorkoutView, SetRecordListView, UpdateSetOrderView, UpdateSetGroupOrderView, WorkoutCopyView, WorkoutDestroyView, WorkoutListCreateView, WorkoutDetailView, SetListCreateView, SetGroupListCreateView, SetGroupDestroyView, ExerciseListView, SetRetrieveUpdateDestroyView, UserProfileView
...
urlpatterns = [
    ...
    path('workouts/<str:date>/set-groups/update-order/', UpdateSetGroupOrderView.as_view(), name="update-setgroup-order"),
